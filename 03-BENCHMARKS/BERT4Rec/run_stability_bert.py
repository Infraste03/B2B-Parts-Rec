# =============================================================================
# RESUMABLE STABILITY ANALYSIS SCRIPT FOR BERT4Rec
#Submitted batch job 2348756
# =============================================================================
"""Resumable Stability Analysis Script for BERT4Rec on Leave-One-Out Split
...
if __name__ == '__main__':
    ...
    # Load the optimal hyperparameters from the JSON file.
    ...
    for i, seed in enumerate(seeds_to_run):
        ...
        # Base configuration for RecBole
        config_dict = {
            'model': model_name,
            'dataset': 'b2b_data',
            'data_path': '../../dataset/',
