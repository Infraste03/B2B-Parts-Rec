#!/bin/bash
# ==============================================================================
# SLURM SUBMISSION SCRIPT FOR FDSA HYPERPARAMETER OPTIMIZATION (HPO)
# ==============================================================================
#
...
# to execute the hyperparameter optimization (HPO) for the FDSA (Feature-aware
# Transformer-based Sequential Recommendation) model by running the
# `run_hpo_fdsa.py` Python script.
#
# Key Features:
# -------------
...
# - The `run_hpo_fdsa.py` script and the dataset must be in the correct
#   relative paths.
#
# ==============================================================================
...
#SBATCH --job-name=FDSA-HPO   
#SBATCH --output=FDSA-HPO_%j.log 
...
# Launch the hyperparameter optimization script for FDSA.
echo "Starting Hyperparameter Optimization (HPO) for FDSA..."
