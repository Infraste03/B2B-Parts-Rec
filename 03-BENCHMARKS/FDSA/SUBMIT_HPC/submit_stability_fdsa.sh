...
#SBATCH --job-name=FDSA-STABILITY
#SBATCH --output=FDSA-STABILITY_%j.log
...
# Launch the stability analysis script for FDSA.
echo "Starting stability analysis for FDSA..."

python run_stability_fdsa.py
