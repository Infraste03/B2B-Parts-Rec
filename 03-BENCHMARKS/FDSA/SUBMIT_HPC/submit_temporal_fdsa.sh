...
#SBATCH --job-name=FDSA-TEMPORAL
#SBATCH --output=FDSA-TEMPORAL_%j.log
#SBATCH --output=FDSA-TEMPORAL_%j.log 
...
# Launch the TEMPORAL analysis script for FDSA.
echo "Starting TEMPORAL Analysis for FDSA..."


python run_stability_fdsa_temporal.py
