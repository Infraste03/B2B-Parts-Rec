# =============================================================================
# RESUMABLE STABILITY ANALYSIS SCRIPT FOR FDSA ON GLOBAL TEMPORAL SPLIT
# 2348750
# =============================================================================
"""Resumable Stability Analysis Script for FDSA on a Global Temporal Split
...
weight initialization when trained and evaluated on a different data splitting strategy.
...
- The dataset must be available in the configured `data_path`, including both
  interaction (`.inter`) and item feature (`.item`) files.
