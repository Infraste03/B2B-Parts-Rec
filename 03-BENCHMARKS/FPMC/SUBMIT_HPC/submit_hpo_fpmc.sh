#!/bin/bash
# ==============================================================================
# SLURM SUBMISSION SCRIPT FOR FPMC HYPERPARAMETER OPTIMIZATION (HPO)
# ==============================================================================
#
...
# to execute the resumable hyperparameter optimization (HPO) for the FPMC
# (Factorizing Personalized Markov Chains) model by running the `run_hpo_fpmc.py`
# Python script.
#
# Key Features:
# -------------
...
# - The `run_hpo_fpmc.py` script and the dataset must be in the correct
#   relative paths.
#
# ==============================================================================
...
#SBATCH --job-name=fpmc-HPO   
#SBATCH --output=FPMC-HPO_%j.log 
...
# Launch the hyperparameter optimization script for FPMC.
echo "Starting Hyperparameter Optimization (HPO) for FPMC..."

python run_hpo_fpmc.py
