...
#SBATCH --job-name=FPMC-STABILITY
#SBATCH --output=FPMCSTABILITY_%j.log
#SBATCH --output=FPMC-STABILITY_%j.log 
...
# Launch the stability analysis script for FPMC.
echo "Starting Stability Analysis for FPMC..."


python run_stability_fpmc.py
