# =============================================================================
# RESUMABLE STABILITY ANALYSIS SCRIPT FOR FPMC
#2348748
# =============================================================================
"""Resumable Stability Analysis Script for FPMC on a Global Temporal Split

This script performs a robust and resumable stability analysis for the FPMC
(Factorizing Personalized Markov Chains) model. The purpose of this analysis is
...
if __name__ == '__main__':
    ...
    params_file = '../../04-BEST_PARAM/fpmc.json'
    #params_file = '/hpc/scratch/francesca.stefano/RECBOLE/hpc_deploy/fpmc.json' # JUST 4 HPC TEST
