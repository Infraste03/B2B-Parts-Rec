#!/bin/bash
# ==============================================================================
# SLURM SUBMISSION SCRIPT FOR GRU4Rec HYPERPARAMETER OPTIMIZATION (HPO)
# ==============================================================================
#
...
# to execute the resumable hyperparameter optimization (HPO) for the GRU4Rec
# model by running the `run_hpo_gru4rec.py` Python script.
#
# Key Features:
# -------------
...
# - The `run_hpo_gru4rec.py` script and the dataset must be in the correct
#   relative paths.
#
# ==============================================================================
...
#SBATCH --job-name=GRU4Rec-HPO   
#SBATCH --output=GRU4Rec-HPO_%j.log 
...
# Launch the hyperparameter optimization script for GRU4Rec.
echo "Starting Hyperparameter Optimization (HPO) for GRU4Rec..."
