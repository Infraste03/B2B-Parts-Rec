...
#SBATCH --job-name=GRU-STABILITY
#SBATCH --output=GRUSTABILITY_%j.log
#SBATCH --output=GRU-STABILITY_%j.log 
...
# Launch the stability analysis script for GRU4Rec.
echo "Starting Stability Analysis for GRU4Rec..."


python run_stability_gru4rec.py
