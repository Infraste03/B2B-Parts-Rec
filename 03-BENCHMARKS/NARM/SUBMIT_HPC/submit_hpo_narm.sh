#!/bin/bash
# ==============================================================================
# SLURM SUBMISSION SCRIPT FOR NARM HYPERPARAMETER OPTIMIZATION (HPO)
# ==============================================================================
#
...
# to execute the hyperparameter optimization (HPO) for the NARM (Neural Attentive
# Session-based Recommendation) model by running the `run_hpo_narm.py` Python script.
#
# Key Features:
# -------------
...
# - The `run_hpo_narm.py` script and the dataset must be in the correct
#   relative paths.
#
# ==============================================================================
...
#SBATCH --job-name=NARM-HPO   
#SBATCH --output=NARM-HPO_%j.log 
...
# Launch the hyperparameter optimization script for NARM.
echo "Starting Hyperparameter Optimization (HPO) for NARM..."
