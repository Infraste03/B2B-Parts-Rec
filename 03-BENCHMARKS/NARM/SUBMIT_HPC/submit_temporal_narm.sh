...
#SBATCH --job-name=NARM-temporal
#SBATCH --output=NARM-temporal_%j.log
#SBATCH --output=NARM-temporal_%j.log
...
# Launch the stability analysis script for NARM.
echo "Starting temporal Analysis for NARM..."

python run_stability_narm_temporal.py
