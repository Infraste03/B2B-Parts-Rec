# =============================================================================
# RESUMABLE STABILITY ANALYSIS SCRIPT FOR NARM ON GLOBAL TEMPORAL SPLIT
#2348739
# =============================================================================
"""Resumable Stability Analysis Script for NARM on a Global Temporal Split

This script performs a robust and resumable stability analysis for the NARM
(Neural Attentive Session-based Recommendation) model. The purpose of this analysis
is to evaluate how sensitive the model's performance is to random weight initialization
...
if __name__ == '__main__':
    ...
    params_file = '../../04-BEST_PARAM/narm.json'
    #params_file = '/hpc/scratch/francesca.stefano/RECBOLE/hpc_deploy/narm.json'
