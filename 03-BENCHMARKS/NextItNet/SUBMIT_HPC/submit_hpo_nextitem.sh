#!/bin/bash
# ==============================================================================
# SLURM SUBMISSION SCRIPT FOR NextItNet HYPERPARAMETER OPTIMIZATION (HPO)
# ==============================================================================
#
...
# to execute the resumable hyperparameter optimization (HPO) for the NextItNet
# model by running the `run_hpo_nextitnet.py` Python script.
#
# Key Features:
# -------------
...
# - The `run_hpo_nextitnet.py` script and the dataset must be in the correct
#   relative paths.
#
# ==============================================================================
...
#SBATCH --job-name=NextItNet-HPO 
#SBATCH --output=NextItNet-HPO_%j.log
...
# Launch the hyperparameter optimization script for NextItNet.
echo "Starting Hyperparameter Optimization (HPO) for NextItNet..."
#

python run_hpo_nextitem.py
