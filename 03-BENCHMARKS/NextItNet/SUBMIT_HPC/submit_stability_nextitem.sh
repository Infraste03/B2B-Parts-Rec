...
#SBATCH --job-name=nextitnet-STABILITY
#SBATCH --output=NEXTITNET-STABILITY_%j.log
#SBATCH --output=NEXTITNET-STABILITY_%j.log
...
echo "Starting Stability Analysis for nextitnet..."

python run_stability_nextitnet.py
