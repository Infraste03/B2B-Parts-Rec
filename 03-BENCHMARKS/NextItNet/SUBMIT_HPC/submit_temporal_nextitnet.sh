...
#SBATCH --job-name=nextitnet-temporal
#SBATCH --output=NEXTITNET-temporal_%j.log
#SBATCH --output=NEXTITNET-temporal_%j.log
...
# Launch the stability analysis script for nextitnet.
echo "Starting temporal Analysis for nextitnet..."

python run_stability_nextitnet_temporal.py
