# =============================================================================
# RESUMABLE STABILITY ANALYSIS SCRIPT FOR NextItNet
#2348738
# =============================================================================
"""Resumable Stability Analysis Script for NextItNet on a Global Temporal Split

This script performs a robust and resumable stability analysis for the NextItNet
model. The purpose of this analysis is to evaluate how sensitive the model's
performance is to random weight initialization when trained and evaluated on a
...
if __name__ == '__main__':
    ...
    model_name = 'NextItNet'
    seeds_to_run = [2024, 199, 42, 1024, 888]
    results_file = f"stability_results_{model_name}_temporal_split_second.csv"
    params_file = '../../04-BEST_PARAM/nextitnet.json'
    #params_file = '/hpc/scratch/francesca.stefano/RECBOLE/hpc_deploy/nextitnet.json' # Path on HPC system
