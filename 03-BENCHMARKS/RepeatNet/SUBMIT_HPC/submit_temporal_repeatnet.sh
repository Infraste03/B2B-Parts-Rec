...
#SBATCH --job-name=RepeatNet-STABILITY-TEMPORAL
#SBATCH --output=RepeatNet-STABILITY-TEMPORAL_%j.log
...
# relative outputs (e.g. stability_results_RepeatNet_temporal_split.csv)
# are saved there.
cd /hpc/scratch/francesca.stefano/KG_RS/RepeatNet

# --- 3. Python Script Execution ---

# Launch the temporal-split stability analysis script for RepeatNet.
echo "Starting Temporal Split Stability Analysis for RepeatNet..."
