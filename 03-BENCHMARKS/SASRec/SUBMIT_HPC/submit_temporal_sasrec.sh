...
#SBATCH --job-name=sasrec-temporal
#SBATCH --output=sasrec-TEMPORAL_%j.log
#SBATCH --output=sasrec-TEMPORAL_%j.log
...
# Launch the stability analysis script for sasrec.
echo "Starting temporal Analysis for sasrec..."

python run_stability_sasrec_temporal.py
