# =============================================================================
# RESUMABLE STABILITY ANALYSIS SCRIPT FOR SASRec
#2348725
# =============================================================================
"""Resumable Stability Analysis Script for SASRec on Leave-One-Out Split

This script performs a robust and resumable stability analysis for the SASRec
(Self-Attentive Sequential Recommendation) model. The purpose of this analysis is
...
if __name__ == '__main__':
    ...
    params_file = '../../04-BEST_PARAM/sasrec.json'
    #params_file = '/hpc/scratch/francesca.stefano/RECBOLE/hpc_deploy/sasrec.json' #hpc
